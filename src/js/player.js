...
(function($) {
    ...
    apbp.audioPicturebookPlayer.prototype = {
        ...
        playTrack: function(track) {
            var t = this;
            try { t.media.pause(); } catch(e){ console.log(e); }
        ...
        buildaudiofullscreen: function(player, controls, layers, media) {
            ...
            t.fullscreenBtn = $('<span class="apbp-button apbp-fullscreen-expandcontract">'
                    + '<button type="button" aria-controls="' + t.id + '" class="compress" title="' + t.options.fullscreenTextExit + '" aria-label="' + t.options.fullscreenTextExit + '">'
                    ...
                    + '</button>'
                    + '<button type="button" aria-controls="' + t.id + '" class="expand" title="' + t.options.fullscreenText + '" aria-label="' + t.options.fullscreenText + '">'
                    + '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 32 448 448"><path class="expand" d="M0 180V56c0-13.3 10.7-24 24-24h124c6.6 0 12 5.4 12 12v40c0 6.6-5.4 12-12 12H64v84c0 6.6-5.4 12-12 12H12c-6.6 0-12-5.4-12-12zM288 44v40c0 6.6 5.4 12 12 12h84v84c0 6.6 5.4 12 12 12h40c6.6 0 12-5.4 12-12V56c0-13.3-10.7-24-24-24H300c-6.6 0-12 5.4-12 12zm148 276h-40c-6.6 0-12 5.4-12 12v84h-84c-6.6 0-12 5.4-12 12v40c0 6.6 5.4 12 12 12h124c13.3 0 24-10.7 24-24V332c0-6.6-5.4-12-12-12zM160 468v-40c0-6.6-5.4-12-12-12H64v-84c0-6.6-5.4-12-12-12H12c-6.6 0-12 5.4-12 12v124c0 13.3 10.7 24 24 24h124c6.6 0 12-5.4 12-12z"/></svg>'
                    + '</button>'
                    + "</span>");
